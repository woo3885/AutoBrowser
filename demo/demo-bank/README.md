...
> **선택/레거시 프로젝트:** 현재 AutoBrowser는 실제 Chrome 탭에서 작동하므로 표준 Railway 배포에 이 앱이 필요하지 않습니다. 이 프로젝트는 과거 금융 흐름과 안전 Gate의 Mock/E2E 참고용으로 유지합니다. 현재 사용법은 [루트 README](../../README.md)를 참고하세요.
